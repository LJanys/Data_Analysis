...
```{r, error = TRUE,eval=F }
 1.224606e-16
```
is interpreted as $1.224606 \times 10^{-16}$. This is often exactly zero, but for internal memory purposes (R only has up to 16 decimals), can be a rounding mistake.
